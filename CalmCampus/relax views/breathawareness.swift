...
struct breathawareness: View {
    ...
    func loadAudio() {
        guard let soundURL = Bundle.main.url(forResource: "breathmed", withExtension: "mp3") else {
...
struct breathawarenessView_Previews: PreviewProvider {
